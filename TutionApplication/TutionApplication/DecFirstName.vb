...
Public Class DecFirstName
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TutionApplication.DecFirstName.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDecFirstName
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DecFirstName = New DecFirstName()
        rpt.Site = Me.Site
        Return rpt
    End Function
