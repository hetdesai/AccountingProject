...
Public Class rptoutpartysummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptoutpartysummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptoutpartysummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptoutpartysummary = New rptoutpartysummary
        rpt.Site = Me.Site
        Return rpt
    End Function
