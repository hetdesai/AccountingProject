...
Public Class rptoutitemmonthly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptoutitemmonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptoutitemmonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptoutitemmonthly = New rptoutitemmonthly
        rpt.Site = Me.Site
        Return rpt
    End Function
