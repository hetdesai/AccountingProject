...
Public Class rptoutitemdetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptoutitemdetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptoutitemdetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptoutitemdetail = New rptoutitemdetail
        rpt.Site = Me.Site
        Return rpt
    End Function
