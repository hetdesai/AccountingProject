            ...
            With frmpenlotsele
                ...
                If .CheckedListBox1.CheckedItems.Count = 0 Then
                    For i = 0 To .CheckedListBox1.Items.Count - 1
                        group = group & "pgroup='" & .CheckedListBox1.Items(i).ToString & "' or "
                    Next
                Else
                    For i = 0 To .CheckedListBox1.CheckedItems.Count - 1
                        group = group & "pgroup='" & .CheckedListBox1.CheckedItems(i).ToString & "' or "
                    Next
                End If
                group = group.Substring(0, group.Length - 4)
                If .CheckedListBox2.CheckedItems.Count = 0 Then
                    For i = 0 To .CheckedListBox2.Items.Count - 1
                        Name = Name & "acname='" & .CheckedListBox2.Items(i).ToString & "' or "
                    Next
                Else
                    For i = 0 To .CheckedListBox2.CheckedItems.Count - 1
                        Name = Name & "acname='" & .CheckedListBox2.CheckedItems(i).ToString & "' or "
                    Next
                End If
                Name = Name.Substring(0, Name.Length - 4)
                If .CheckedListBox3.CheckedItems.Count = 0 Then
                    For i = 0 To .CheckedListBox3.Items.Count - 1
                        lotno = lotno & "lotno='" & .CheckedListBox3.Items(i).ToString & "' or "
                    Next
                Else
                    For i = 0 To .CheckedListBox3.CheckedItems.Count - 1
                        lotno = lotno & "lotno='" & .CheckedListBox3.CheckedItems(i).ToString & "' or "
                    Next
                End If
                Try
                ...
                If .CheckedListBox5.CheckedItems.Count = 0 Then
                    For i = 0 To .CheckedListBox5.Items.Count - 1
                        item = item & "item='" & .CheckedListBox5.Items(i).ToString & "' or "
                    Next
                Else
                    For i = 0 To .CheckedListBox5.CheckedItems.Count - 1
                        item = item & "item='" & .CheckedListBox5.CheckedItems(i).ToString & "' or "
                    Next
                End If
                item = item.Substring(0, item.Length - 4)
                If .CheckedListBox4.CheckedItems.Count = 0 Then
                    For i = 0 To .CheckedListBox4.Items.Count - 1
                        mst = mst & "mst='" & .CheckedListBox4.Items(i).ToString & "' or "
                    Next
                Else
                    For i = 0 To .CheckedListBox4.CheckedItems.Count - 1
                        mst = mst & "mst='" & .CheckedListBox4.CheckedItems(i).ToString & "' or "
                    Next
                End If
                ...
                connect()
                da = New SqlDataAdapter("select * from tblLotr where (" & Name & ") and (" & lotno & ") and (" & item & ") and (" & mst & ") and date>='" & dat1.Month & "-" & dat1.Day & "-" & dat1.Year & "' and date<='" & dat2.Month & "-" & dat2.Day & "-" & dat2.Year & "' and isdesp='f'", cn)
                da.Fill(ds, "tblLotr")
