...
Public Class Copy_of_rptch1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.Copy of rptch1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_rptch1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_rptch1 = New Copy_of_rptch1
        rpt.Site = Me.Site
        Return rpt
    End Function
