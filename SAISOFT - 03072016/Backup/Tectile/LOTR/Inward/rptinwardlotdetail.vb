...
Public Class rptinwardlotdetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptinwardlotdetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptinwardlotdetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptinwardlotdetail = New rptinwardlotdetail
        rpt.Site = Me.Site
        Return rpt
    End Function
