...
Public Class frmprintaccount
    Dim da As New SqlDataAdapter
    Dim ds As New DataSet
    Private Sub frmprintaccount_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
