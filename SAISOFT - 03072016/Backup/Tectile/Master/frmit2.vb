...
Public Class frmit2
    ...
    Private Sub frmit2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        da = New SqlDataAdapter("select * from tblIt2 where code not like 'SST%' order by srno", cn)
        da.Fill(ds)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            If TextBox4.Text.Length > 18 Then
                MsgBox("can not insert more than 18 chars")
                TextBox4.Focus()
                GoTo en
            End If
            ...
            ElseIf Label6.Text = "EDIT" Then
                ...
                Dim da As New SqlDataAdapter
                Dim ds As New DataSet
                da = New SqlDataAdapter("select * from tblIt2 where code not like 'SST%'", cn)
                da.Fill(ds)
                dg1.DataSource = ds.Tables(0)
                Try
                    dg1.Item(0, dg1.RowCount - 1).Selected = True
