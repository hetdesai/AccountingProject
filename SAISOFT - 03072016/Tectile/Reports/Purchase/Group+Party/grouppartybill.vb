...
Public Class grouppartybill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.grouppartybill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgrouppartybill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As grouppartybill = New grouppartybill()
        rpt.Site = Me.Site
        Return rpt
    End Function
