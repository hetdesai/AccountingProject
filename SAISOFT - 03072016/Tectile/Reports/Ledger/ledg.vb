...
Public Class ledg
    ...
    Private Sub ledg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Next
            Dim i As Integer
            If disledg.CustomeChecklistbox1.CheckedItemsCount = 0 Then
                For i = 0 To disledg.CustomeChecklistbox1.ItemsCount - 1
                    connect()
                    Dim trcount As Integer
                    Dim cmd As New SqlCommand
                    Dim dr As SqlDataReader
                    cmd = New SqlCommand("Select count(VRNo) from tblLedg where ACName='" & disledg.CustomeChecklistbox1.getItems(i).ToString & "'", cn)
                    dr = cmd.ExecuteReader
                    While dr.Read
                        trcount = dr.Item(0)
                    End While
                    ...
                    If trcount = 0 Then
                    Else
                        li.Items.Add(disledg.CustomeChecklistbox1.getItems(i).ToString)
                    End If
                    close1()
                Next
            Else
                For i = 0 To disledg.CustomeChecklistbox1.CheckedItemsCount - 1
                    connect()
                    Dim trcount As Integer
                    Dim cmd As New SqlCommand
                    Dim dr As SqlDataReader
                    cmd = New SqlCommand("Select count(VRNo) from tblLedg where ACName='" & disledg.CustomeChecklistbox1.getCheckedItems(i).ToString & "'", cn)
                    dr = cmd.ExecuteReader
                    While dr.Read
                        trcount = dr.Item(0)
                    End While
                    ...
                    If trcount = 0 Then
                    Else
                        li.Items.Add(disledg.CustomeChecklistbox1.getCheckedItems(i).ToString)
                    End If
                    close1()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            If disledg.CustomeChecklistbox1.CheckedItemsCount = 0 Then
                For cno = 0 To disledg.CustomeChecklistbox1.ItemsCount - 1
                    ac1 = ac1 & "ACName='" & disledg.CustomeChecklistbox1.getItems(cno).ToString & "' Or "
                Next
            Else
                For cno = 0 To disledg.CustomeChecklistbox1.CheckedItemsCount - 1
                    ac1 = ac1 & "ACName='" & disledg.CustomeChecklistbox1.getCheckedItems(cno).ToString & "' Or "
                Next
            End If
