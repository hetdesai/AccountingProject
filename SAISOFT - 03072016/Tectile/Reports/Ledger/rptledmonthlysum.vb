...
Public Class rptledmonthlysum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptledmonthlysum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptledmonthlysum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptledmonthlysum = New rptledmonthlysum()
        rpt.Site = Me.Site
        Return rpt
    End Function
