...
Public Class sgroupmonthly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.sgroupmonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsgroupmonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As sgroupmonthly = New sgroupmonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
