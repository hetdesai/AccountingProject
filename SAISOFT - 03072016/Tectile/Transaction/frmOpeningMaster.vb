...
Public Class frmOpeningMaster
    ...
    Private Sub cmdExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butExit.Click
        ...
        Me.Close()
    End Sub
    Private Sub gotfocus1(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtVrNo.GotFocus, txtAcname.GotFocus, txtAccode.GotFocus, txtAmount.GotFocus, txtDesc.GotFocus, maskDate.GotFocus
        Try
        ...
        End Try
    End Sub
    Private Sub lostfocus1(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtVrNo.LostFocus, txtAcname.LostFocus, txtAccode.LostFocus, txtAmount.LostFocus, txtDesc.LostFocus, maskDate.LostFocus
        Try
...
en:
    ...
    End Sub
    Private Sub TextBox5_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            txtDesc.Focus()
        ElseIf e.KeyCode = Keys.Up Then
            txtAmount.Focus()
    ...
    Private Sub TextBox5_Leave(ByVal sender As Object, ByVal e As System.EventArgs)
...
en:
    ...
    Private Sub txtType_Enter(sender As Object, e As EventArgs) Handles txtType.Enter
