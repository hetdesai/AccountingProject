...
EN:
    ...
    Private Sub butAdd_MouseEnter(sender As Object, e As EventArgs) Handles butFind.MouseEnter, butExit.MouseEnter, butEdit.MouseEnter, butDelete.MouseEnter, butAdd.MouseEnter
        sender.backcolor = Color.Blue
        sender.forecolor = Color.White
    End Sub
