...
en:     Catch ex As Exception
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            If MessageBox.Show("Are you sure? Do you want to delete this group", "Verify", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                ...
                If DR.HasRows Then
                    MsgBox("You can not delete this group. It is present in the account")
                    DR.Close()
                    GoTo EN
                Else
                    DR.Close()
