    ...
    Private Sub frmGroupMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If frmACMaster.groupcheck = 1 Then
                ...
                myserialno("tblMachine", TextBox1, "MachineCode")
                GroupBox1.Focus()
                TextBox2.Focus()
            Else
                connect()
                myfilldatagrid(dg1, "tblMachine")
                Try
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            If TextBox2.Text.Trim.Length = 0 Then
                MsgBox("Machine Name can not be blank")
                TextBox2.Focus()
                GoTo en
            End If
            If check = 1 Then
                ...
                If duplicate("tblMachine", "Machineno", TextBox2) Then
                    MsgBox("Machine already exists")
                    TextBox2.Focus()
                    GoTo en
                Else
                End If
                myinsert(a, "tblMachine")
                myfilldatagrid(dg1, "tblMachine")
                dg1.Item(0, dg1.RowCount - 1).Selected = True
            ...
            ElseIf check = 2 Then
                Dim a() As String = {TextBox1.Text, TextBox2.Text}
                If (duplicate("tblMachine", "Machineno", TextBox2)) = True Then
                    MsgBox("Machine already exists")
                    TextBox2.Focus()
                    GoTo en
                End If
                ...
                myupdate("tblMachine", a, "MachineCode", TextBox1.Text)
                Dim rowi As Integer
                Dim coli As Integer
                Dim i As DataGridViewSelectedCellCollection
                i = dg1.SelectedCells
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            If MessageBox.Show("Are you sure want to delete entry", "Verify", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                ...
                Dim CMD As New SqlCommand
                Dim dr As SqlDataReader
                CMD = New SqlCommand("Select * from sale1 where MachineNo='" & TextBox2.Text & "'", cn)
                dr = CMD.ExecuteReader
                If dr.HasRows Then
                    MessageBox.Show("You can not delete this Machine. Because it is present in sale entry")
                    dr.Close()
                    GoTo EN
                End If
                dr.Close()
                ...
                CMD = New SqlCommand("DELETE FROM tblMachine WHERE Machineno='" & TextBox2.Text & "'", cn)
                CMD.ExecuteNonQuery()
                myfilldatagrid(dg1, "tblMachine")
                close1()
            End If
