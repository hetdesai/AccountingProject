    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            ...
            ElseIf check = 2 Then
                ...
                Try
                    Dim cmd As New SqlCommand
                    cmd = New SqlCommand("Update tblItem set ittype='" & TextBox2.Text & "' where ittype='" & TextBox4.Text & "'", cn)
                    cmd.ExecuteNonQuery()
                    cmd = New SqlCommand("Update tblstock set ittype='" & TextBox2.Text & "' where ittype='" & TextBox4.Text & "'", cn)
                    cmd.ExecuteNonQuery()
                Catch ex As Exception
...
en:
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        Try
            If MessageBox.Show("Are you sure? Do you want to delete this Item Type", "Verify", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                connect()
                Dim CMD As New SqlCommand
                Dim DR As SqlDataReader
