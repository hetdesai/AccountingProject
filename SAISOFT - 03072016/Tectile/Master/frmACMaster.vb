        ...
        Try
            ...
            ElseIf check = 2 Then
                ...
                If txtAcname.Text.Trim <> txtcopyacname.Text.Trim Then
                    ...
                    If MessageBox.Show("You have changed ACNAME. All the transactions will be changed. Do you want to continue?", "Verify", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                        updateaccount()
                    Else
                        GoTo en
                    End If
...
en:
    ...
    Private Sub updateaccount()
        Try
            ...
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update advpmt set bkname='" & txtAcname.Text & "' where bkname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update adv set acname='" & txtAcname.Text & "' where acname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update adv set bkname='" & txtAcname.Text & "' where bkname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            ...
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update ch1 set acname='" & txtAcname.Text & "' where acname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update ch1 set bkname='" & txtAcname.Text & "' where bkname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update ratemst set acname='" & txtAcname.Text & "' where acname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            ...
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update sale1 set bkname='" & txtAcname.Text & "' where bkname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update sale1 set name='" & txtAcname.Text & "' where name='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update sale1 set namecr='" & txtAcname.Text & "' where namecr='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update sale set bkname='" & txtAcname.Text & "' where bkname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update sale set name='" & txtAcname.Text & "' where name='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update sale set namecr='" & txtAcname.Text & "' where namecr='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update salet set bkname='" & txtAcname.Text & "' where bkname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update salet set name='" & txtAcname.Text & "' where name='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update salet set namecr='" & txtAcname.Text & "' where namecr='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
            ...
            cmd.ExecuteNonQuery()
            cmd = New SqlCommand("update tblLedg set opname='" & txtAcname.Text & "' where opname='" & txtcopyacname.Text & "'", cn)
            cmd.ExecuteNonQuery()
