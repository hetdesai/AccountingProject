...
Public Class frmMainScreen
    ...
    Dim WithEvents g1 As New ToolStripMenuItem
    Dim i As Integer
    ...
    Private Sub frmMainScreen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            While dr.Read
                ...
                g1 = New System.Windows.Forms.ToolStripMenuItem
                g1.Text = dr.Item(1).ToString
                AddHandler g1.Click, AddressOf w1
                Me.BankReconcilationToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {g1})
    ...
    Private Sub w(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles g.Click
        ...
        frmBankRecipt.Show()
    End Sub
    Private Sub w1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles g1.Click
        ' frmITMaster.Show()
        bankrnam = sender.ToString
        frmBankRec.Show()
    End Sub
    ...
    Private Sub BankCashPaymentToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BankCashPaymentToolStripMenuItem.Click

    End Sub

    Private Sub TransferToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles TransferToolStripMenuItem1.Click
        frmbilltransfer.show()
    End Sub

    Private Sub CheckVerifyToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CheckVerifyToolStripMenuItem.Click
        frmCheckClear.Show()
    End Sub
End Class
