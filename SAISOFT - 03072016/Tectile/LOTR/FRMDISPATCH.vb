...
LAST:
    ...
    Private Sub billno123()
        Try
            ...
            Dim cmd As New SqlCommand
            Dim dr As SqlDataReader
            cmd = New SqlCommand("select max(Convert(INT,BILLno)) from sale", cn)
            dr = cmd.ExecuteReader
            While dr.Read
                Try
                    txtBillNosecond.Text = Val(dr.Item(0).ToString) + 1
    ...
    Private Sub gridfill1()
        Try
            ...
            da = New SqlDataAdapter("select Vrno,billdt,billno,Name,Pcs,Qty,NetAmt,BKName,mst,delvary from sale order by convert(INT,substring(vrno,4,LEN(vrno)-3))", cn)
            da.Fill(ds)
    ...
    Private Sub FRMDISPATCH_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FRMDISPATCH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            While dr.Read
                ...
                txtBkname1.Items.Add(dr.Item(0))
            End While
            dr.Close()
    ...
    Private Sub fillsale1()
        Try
            ...
            While dr.Read
                ...
                dg1.Item(7, i).Value = dr.Item("mst")
                dg1.Item(8, i).Value = dr.Item("width")
                dg1.Item(9, i).Value = dr.Item("grpcs")
                dg1.Item(10, i).Value = dr.Item("grmtr")
                dg1.Item(11, i).Value = dr.Item("grrate")
                dg1.Item(12, i).Value = dr.Item("grval")
                dg1.Item(13, i).Value = dr.Item("pcs")
                dg1.Item(14, i).Value = dr.Item("qty")
                dg1.Item(15, i).Value = dr.Item("rate")
                dg1.Item(16, i).Value = dr.Item("amount")
                dg1.Item(17, i).Value = dr.Item("Remark")
                dg1.Item(6, i).Value = dr.Item("Shade")
                dg1.Item(18, i).Value = dr.Item("desgno")
                dg1.Item(19, i).Value = dr.Item("Machineno")
                i = i + 1
            End While
            dr.Close()
            close1()
    ...
    Private Sub TextBox1_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtName.GotFocus, txtregcode1.GotFocus, txtBillNosecond.GotFocus, txtBillNofirst.GotFocus, TextBox14.GotFocus, TextBox15.GotFocus, TextBox16.GotFocus, TextBox17.GotFocus, TextBox18.GotFocus, TextBox19.GotFocus, txtNamecr.GotFocus, txtJvvrno.GotFocus, txtRemark.GotFocus, txtAccodecr.GotFocus, txtAccode.GotFocus, TextBox24.GotFocus, txtVehicalno.GotFocus, TextBox3.GotFocus, TextBox4.GotFocus, txtvrno1.GotFocus, txtInvoiceNo.GotFocus, txtDelv.GotFocus, txtMarka.GotFocus, txtGroup.GotFocus, MaskedTextBox1.GotFocus, ComboBox1.GotFocus
        sender.backcolor = Color.Pink
    End Sub
    Private Sub TextBox11_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtName.GotFocus
        keydowncheck = 0
    End Sub
...
en:
    ...
    Private Sub txtRemark_KeyDown(sender As Object, e As KeyEventArgs) Handles txtRemark.KeyDown
        ...
        End If
    End Sub
    Private Sub TextBox1_lostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtregcode1.LostFocus, txtBillNosecond.LostFocus, txtBillNofirst.LostFocus, TextBox14.LostFocus, TextBox15.LostFocus, TextBox16.LostFocus, TextBox17.LostFocus, TextBox18.LostFocus, TextBox19.LostFocus, txtNamecr.LostFocus, txtJvvrno.LostFocus, txtRemark.LostFocus, txtAccodecr.LostFocus, txtAccode.LostFocus, TextBox24.LostFocus, txtVehicalno.LostFocus, TextBox3.LostFocus, TextBox4.LostFocus, txtvrno1.LostFocus, txtInvoiceNo.LostFocus, txtDelv.LostFocus, txtMarka.LostFocus, txtGroup.LostFocus, MaskedTextBox1.LostFocus, ComboBox1.LostFocus
    ...
    Private Sub dg1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dg1.CellClick
        If e.ColumnIndex > 3 And e.ColumnIndex < 14 Then
            dg1.CurrentCell = dg1.Item(14, dg1.CurrentCell.RowIndex)
    ...
    Private Sub dg1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dg1.KeyDown
        Try
            ...
            If e.KeyCode = Keys.Enter Then
                If dg1.CurrentCell.ColumnIndex = dg1.ColumnCount - 4 Then
    ...
    Private Sub dg1_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles dg1.RowsAdded
        If e.RowIndex <> 0 Then
            dg1.Item(0, e.RowIndex).Value = Val(dg1.Item(0, e.RowIndex - 1).Value) + 1
        Else
        ...
        dg1.Item(14, e.RowIndex).Value = 0.0
        dg1.Item(15, e.RowIndex).Value = 0.0
        dg1.Item(16, e.RowIndex).Value = 0.0
        If e.RowIndex <> 0 Then
            dg1.Item(3, e.RowIndex).Value = dg1.Item(3, e.RowIndex - 1).Value
            dg1.Item(5, e.RowIndex).Value = dg1.Item(5, e.RowIndex - 1).Value
            dg1.Item(6, e.RowIndex).Value = dg1.Item(6, e.RowIndex - 1).Value
            dg1.Item("coldesg", e.RowIndex).Value = dg1.Item("coldesg", e.RowIndex - 1).Value
            dg1.Item("colmachine", e.RowIndex).Value = dg1.Item("colmachine", e.RowIndex - 1).Value
            GoTo en
        End If
        Try
            connect()
            ...
            End While
            dr.Close()
            cmd = New SqlCommand("Select process,style,shade,desgno,machineno from sale1 where billno='" & maxbillno & "'", cn)
            dr = cmd.ExecuteReader
            While dr.Read
                dg1.Item(3, 0).Value = dr.Item(0)
                dg1.Item(5, 0).Value = dr.Item(1)
                dg1.Item(6, 0).Value = dr.Item(2)
                dg1.Item("coldesg", 0).Value = dr.Item(3)
                dg1.Item("colmachine", 0).Value = dr.Item(4)
            End While
            dr.Close()
            close1()
        Catch ex As Exception
...
en:
    ...
    Public Sub caldispatch()
        ...
        For i = 0 To dg1.Rows.Count - 1
            TextBox14.Text = Val(TextBox14.Text) + dg1.Item(16, i).Value
            TextBox15.Text = Val(TextBox15.Text) + dg1.Item(14, i).Value
            TextBox16.Text = Val(TextBox16.Text) + dg1.Item(13, i).Value
            TextBox17.Text = Val(TextBox17.Text) + dg1.Item(10, i).Value
            TextBox18.Text = Val(TextBox18.Text) + dg1.Item(9, i).Value
        Next
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Me.Close()
    End Sub
    Private Sub dgcolumns(b As Boolean)
        dg1.Columns(1).ReadOnly = b
        dg1.Columns(15).ReadOnly = b
        dg1.Columns(16).ReadOnly = b
    End Sub
            ...
            If lotcheck = 0 Then
                If e.ColumnIndex = 2 Then
                    ...
                    Else
                        ...
                        End While
                        dr2.Close()
                        If dg1.CurrentCell.RowIndex = 0 And Label22.Text.ToUpper = "ADD" Then
                            If MsgBox("Lot no " & dg1.Item(1, e.RowIndex).Value.ToString & dg1.Item(2, e.RowIndex).Value.ToString & " is not for " & txtName.Text & ". It is for " & acname, MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                                txtName.Text = acname
                                getData()
                                GoTo conti
                            Else
...
conti:
            ...
            End If
            '            End If
            If e.ColumnIndex = dg1.ColumnCount - 5 Then
                dg1.Item(dg1.ColumnCount - 4, e.RowIndex).Value = Format(Val(Math.Round((dg1.Item(dg1.ColumnCount - 5, e.RowIndex).Value) * Val(dg1.Item(dg1.ColumnCount - 6, e.RowIndex).Value), 0, MidpointRounding.AwayFromZero)), "0.00")
            End If
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
...
en2:
    ...
    Private Function check1() As Boolean
        ...
        ElseIf txtInvoiceNo.Text.Trim.Length = 0 Then
            ...
            Return False
        ElseIf txtDelv.Text.Trim.Length = 0 Then
            '   MsgBox("Delivery can not be blank")
            txtDelv.Text = 0
            '   txtDelv.Focus()
            Return True
        Else
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        caldispatch()
        If dg1.Rows.Count = 0 Or (Val(TextBox14.Text) = 0 And Val(TextBox15.Text) And Val(TextBox17.Text) = 0) Then
            MessageBox.Show("Enter at least one detail entry. Can't save this entry")
            GoTo en1
        End If
        If check1() Then
        Else
        ...
        If Label22.Text = "ADD" Then
            Try
                ...
                Dim a() As String = {txtvrno1.Text, txtbkname1.Text, txtregcode1.Text, txtInvoiceNo.Text, dat.Month & "-" & dat.Day & "-" & dat.Year, txtBillNosecond.Text, txtBillNofirst.Text & txtBillNosecond.Text, dat.Month & "-" & dat.Day & "-" & dat.Year, txtName.Text, txtNamecr.Text, Val(TextBox16.Text), Val(TextBox15.Text), Val(TextBox14.Text), 0, TextBox19.Text, txtJvvrno.Text, Val(TextBox14.Text), AmtInWord(Val(TextBox14.Text)), txtRemark.Text, txtAccode.Text, txtAccodecr.Text, TextBox24.Text, TextBox4.Text, TextBox18.Text, TextBox17.Text, 0, txtDelv.Text, Today.TimeOfDay.ToString, txtVehicalno.Text}
                myinsert(a, "sale")
                Dim I As Integer
                For I = 0 To dg1.RowCount - 1
                    connect()
                    Try
                        If dg1.Item(13, I).Value = 0 Or dg1.Item(14, I).Value = 0 Then
                            GoTo en
                        End If
                    ...
                    End While
                    dr.Close()
                    CMD = New SqlCommand("select mstcode from mst where mst='" & dg1.Item(7, I).Value.ToString & "'", cn)
                    dr = CMD.ExecuteReader
                    While dr.Read
                        mstcode = dr.Item(0)
                    End While
                    dr.Close()
                    Dim b() As String = {txtvrno1.Text, txtbkname1.Text, txtregcode1.Text, txtInvoiceNo.Text, dat.Month & "-" & dat.Day & "-" & dat.Year, txtBillNosecond.Text, txtBillNofirst.Text & txtBillNosecond.Text, dat.Month & "-" & dat.Day & "-" & dat.Year, txtName.Text, txtNamecr.Text, dg1.Item(0, I).Value, dg1.Item(4, I).Value, itcode, dg1.Item(13, I).Value, "1", dg1.Item(14, I).Value, dg1.Item(15, I).Value, "MTR", dg1.Item(16, I).Value, txtAccode.Text, txtAccodecr.Text, prcode, dg1.Item(3, I).Value, dg1.Item(5, I).Value, dg1.Item(6, I).Value, mstcode, dg1.Item(7, I).Value, dg1.Item(8, I).Value, dg1.Item(9, I).Value, dg1.Item(10, I).Value, dg1.Item(11, I).Value, dg1.Item(12, I).Value, dg1.Item(18, I).Value, dg1.Item(1, I).Value & dg1.Item(2, I).Value, "0.0", dg1.Item(17, I).Value, dg1.Item(19, I).Value}
                    description = description & "Lotno=" & dg1.Item(1, I).Value & dg1.Item(2, I).Value & ","
                    myinsert(b, "sale1")
en:
                Next
                ...
                description = description & "billno=" & txtBillNofirst.Text & txtBillNosecond.Text & "invoiceno=" & txtInvoiceNo.Text
                UserAction(frmlogin.TextBox1.Text, "ADD", description, "DISPATCH")
                ds.Tables("lotr").Rows.Clear()
                close1()
                MsgBox("Entry Added")
...
en2:
                ...
                Next
                description = description & "billno=" & txtBillNofirst.Text & txtBillNosecond.Text & "invoiceno=" & txtInvoiceNo.Text
                UserAction(frmlogin.TextBox1.Text, "EDIT", description, "DISPATCH")
                ds.Tables("lotr").Rows.Clear()
                ds2.Tables("lotr").Rows.Clear()
                close1()
                MsgBox("Entry Edited")
    ...
    Private Sub option2()
        ...
        If VALUE = "TRUE" Then
            ...
            For k = 0 To liaccode.Items.Count - 1
                CMD = New SqlCommand("Select acname from tblAccount where accode=" & Val(liaccode.Items(k)), cn)
                DR = CMD.ExecuteReader
                While DR.Read
...
last:
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        If MessageBox.Show("Are you sure want to delete entry", "Verify", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
            ...
            Dim cmd As New SqlCommand
            Dim dr As SqlDataReader
            cmd = New SqlCommand("Select lotno from sale1  where vrno='" & txtvrno1.Text & "'", cn)
            dr = cmd.ExecuteReader
            While dr.Read
                description = description & "Lotno=" & dr.Item(0) & ","
            End While
            dr.Close()
            close1()
            description = description & "Billlno=" & txtBillNofirst.Text & txtBillNosecond.Text & ",Invoice NO=" & txtInvoiceNo.Text
            UserAction(frmlogin.TextBox1.Text, "DELETE", description, "DISPATCH")
            deletecode()
    ...
    Private Sub dg1_CellEnter(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dg1.CellEnter
        Try
            If e.ColumnIndex = 15 Then
                ...
                Dim dr As SqlDataReader
                connect()
                cmd = New SqlCommand("Select * from RateMst where Pgroup='" & txtGroup.Text & "' and Process='" & dg1.Item(3, e.RowIndex).Value & "' and style='" & dg1.Item(5, e.RowIndex).Value & "' and acname='" & txtName.Text & "' and mst='" & TextBox4.Text & "' and item='" & dg1.Item(4, e.RowIndex).Value & "' and shade='" & dg1.Item(6, e.RowIndex).Value & "'", cn)
                dr = cmd.ExecuteReader
                ...
                If dr.HasRows = True Then
                    '  MsgBox("het")
                    While dr.Read
                        dg1.Item(15, e.RowIndex).Value = dr.Item("Rate")
                    End While
                    dr.Close()
                Else
                    If MsgBox("You want to insert rate for this combination", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                        ...
                        value = InputBox("Rate")
                        Dim a() As String = {txtGroup.Text, txtName.Text, TextBox4.Text, dg1.Item(3, e.RowIndex).Value, dg1.Item(5, e.RowIndex).Value, dg1.Item(6, e.RowIndex).Value, dg1.Item(4, e.RowIndex).Value, value}
                        myinsert(a, "RateMst")
                        MsgBox("Inserted")
                        dg1.Item(15, e.RowIndex).Value = value
                    End If

                End If
                close1()
            End If
            'If e.ColumnIndex > 2 And e.ColumnIndex < 13 Then
    ...
    Private Sub TextBox2_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            connect()
            Dim cmd As New SqlCommand
            Dim dr As SqlDataReader
            ...
            If txtregcode1.Text.Trim.Length = 0 Then
                ...
                txtBkname1.Focus()
            End If
            txtBkname1.Text = txtBkname1.Text.ToUpper
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
...
en:
    ...
    Private Sub dg3_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dg3.CellEnter
        Try
            ...
            caldispatch()
            close1()
            System.IO.File.AppendAllText("temp1.txt", e.RowIndex)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    ...
    Private Sub FRMDISPATCH_Paint(sender As Object, e As PaintEventArgs) Handles Me.Paint


    End Sub

    Private Sub Button2_Enter(sender As Object, e As EventArgs) Handles Button8.Enter, Button7.Enter, Button5.Enter, Button4.Enter, Button3.Enter, Button2.Enter, Button11.Enter, Button6.Enter, Button9.Enter
        sender.backcolor = Color.BlueViolet
        sender.forecolor = Color.White
    End Sub

    Private Sub Button2_Leave(sender As Object, e As EventArgs) Handles Button8.Leave, Button7.Leave, Button5.Leave, Button4.Leave, Button3.Leave, Button2.Leave, Button11.Leave, Button6.Leave, Button9.Leave
        sender.backcolor = Color.FromArgb(192, 192, 255)
        sender.forecolor = Color.Black
    End Sub

    Private Sub Button2_MouseHover(sender As Object, e As EventArgs) Handles Button8.MouseHover, Button7.MouseHover, Button5.MouseHover, Button4.MouseHover, Button3.MouseHover, Button2.MouseHover, Button11.MouseHover, Button6.MouseHover, Button9.MouseHover
        sender.backcolor = Color.BlueViolet
        sender.forecolor = Color.White
    End Sub

    Private Sub Button2_MouseLeave(sender As Object, e As EventArgs) Handles Button8.MouseLeave, Button7.MouseLeave, Button5.MouseLeave, Button4.MouseLeave, Button3.MouseLeave, Button2.MouseLeave, Button11.MouseLeave, Button6.MouseLeave, Button9.MouseLeave
        sender.backcolor = Color.FromArgb(192, 192, 255)
        sender.forecolor = Color.Black
    End Sub

    Private Sub txtbkname1_KeyDown(sender As Object, e As KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            txtNamecr.Focus()
        End If
    End Sub

    Private Sub txtNamecr_KeyDown(sender As Object, e As KeyEventArgs) Handles txtNamecr.KeyDown
        If e.KeyCode = Keys.Enter Then
            txtName.Focus()
        ElseIf e.KeyCode = Keys.Up Then
            txtbkname1.Focus()
    ...
    Private Sub Button13_Click(sender As Object, e As EventArgs) Handles Button13.Click
        ...
        If RadioButton3.Checked = True Then
            ...
            temp2 = 2
        Else
            columncount = dg3.ColumnCount - 1
        End If

        tv1 = TextBox20.Text
        If RadioButton3.Checked = False Then
            For i = temp1 To dg3.Rows.Count - 1
                For j = temp2 To columncount
                    If 1 <> 1 Then
                        GoTo a
                    Else
                        If (dg3.Item(j, i).Value.ToString.ToUpper.Contains(TextBox20.Text.ToUpper)) Then
                            Try
                                dg3.Item(j, i).Selected = True
...
a:
        ...
        Else
            For i = temp1 To dg3.Rows.Count - 1
                If (dg3.Item(2, i).Value.ToString.ToUpper.Contains(TextBox20.Text.ToUpper)) Then
                    Try
                        dg3.Item(2, i).Selected = True
...
en:
    ...
    Private Sub txtBkname1_KeyDown1(sender As Object, e As KeyEventArgs) Handles txtBkname1.KeyDown
        If e.KeyCode = Keys.Enter Then
            txtNamecr.Focus()
        End If
    ...
    Private Sub ComboBox2_Leave(sender As Object, e As EventArgs) Handles txtBkname1.Leave
        If txtBkname1.Items.Contains(txtBkname1.Text) = False Then
            MessageBox.Show("Book not in list. Please select from list only")
            txtBkname1.Focus()
        End If
    End Sub

    Private Sub txtBkname1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles txtBkname1.SelectedIndexChanged
        Try
            connect()
            Dim cmd As New SqlCommand
            Dim dr As SqlDataReader
