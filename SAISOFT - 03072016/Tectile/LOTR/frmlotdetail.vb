    ...
    Private Sub frmlotdetail_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            While dr.Read
                ...
                txttotalmtr.Text = dr.Item("gmtr")
            End While
            dr.Close()
            txtACName.Text = FRMDISPATCH.txtName.Text
            txtBillNo.Text = FRMDISPATCH.txtBillNofirst.Text & FRMDISPATCH.txtBillNosecond.Text
            MaskedTextBox1.Text = FRMDISPATCH.MaskedTextBox1.Text
