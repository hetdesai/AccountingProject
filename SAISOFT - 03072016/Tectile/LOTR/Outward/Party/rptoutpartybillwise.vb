...
Public Class rptoutpartybillwise
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptoutpartybillwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptoutpartybillwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptoutpartybillwise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptoutpartybillwise = New rptoutpartybillwise()
        rpt.Site = Me.Site
        Return rpt
    End Function
