        ...
        Dim group As String = ""
            ...
            If frmoutward.CheckedListBox1.CheckedItems.Count = 0 Then
                For i = 0 To frmoutward.CheckedListBox1.Items.Count - 1
                    book = book & "bkname='" & frmoutward.CheckedListBox1.Items(i).ToString & "' or "
                Next
            Else
                For i = 0 To frmoutward.CheckedListBox1.CheckedItems.Count - 1
                    book = book & "bkname='" & frmoutward.CheckedListBox1.CheckedItems(i).ToString & "' or "
                Next
            End If
            book = book.Substring(0, book.Length - 4)
            If frmoutward.CustomeChecklistbox1.CheckedItemsCount = 0 Then
                For i = 0 To frmoutward.CustomeChecklistbox1.ItemsCount - 1
                    group = group & "pgroup='" & frmoutward.CustomeChecklistbox1.getItems(i).ToString & "' or "
                Next
            Else
                For i = 0 To frmoutward.CustomeChecklistbox1.CheckedItemsCount - 1
                    group = group & "pgroup='" & frmoutward.CustomeChecklistbox1.getCheckedItems(i).ToString & "' or "
                Next
            End If
            group = group.Substring(0, group.Length - 4)
            If frmoutward.CustomeChecklistbox2.CheckedItemsCount = 0 Then
                For i = 0 To frmoutward.CustomeChecklistbox2.ItemsCount - 1
                    Name = Name & "name='" & frmoutward.CustomeChecklistbox2.getItems(i).ToString & "' or "
                Next
            Else
                For i = 0 To frmoutward.CustomeChecklistbox2.CheckedItemsCount - 1
                    Name = Name & "name='" & frmoutward.CustomeChecklistbox2.getCheckedItems(i).ToString & "' or "
                Next
            End If
            Name = Name.Substring(0, Name.Length - 4)
            If frmoutward.CustomeChecklistbox4.CheckedItemsCount = 0 Then
                For i = 0 To frmoutward.CustomeChecklistbox4.ItemsCount - 1
                    lotno = lotno & "lotno='" & frmoutward.CustomeChecklistbox4.getItems(i).ToString & "' or "
                Next
            Else
                For i = 0 To frmoutward.CustomeChecklistbox4.CheckedItemsCount - 1
                    lotno = lotno & "lotno='" & frmoutward.CustomeChecklistbox4.getCheckedItems(i).ToString & "' or "
                Next
            End If
            Try
            ...
            End Try
            If frmoutward.CustomeChecklistbox3.CheckedItemsCount = 0 Then
                For i = 0 To frmoutward.CustomeChecklistbox3.ItemsCount - 1
                    item = item & "itname='" & frmoutward.CustomeChecklistbox3.getItems(i).ToString & "' or "
                Next
            Else
                For i = 0 To frmoutward.CustomeChecklistbox3.CheckedItemsCount - 1
                    item = item & "itname='" & frmoutward.CustomeChecklistbox3.getCheckedItems(i).ToString & "' or "
                Next
            End If
            item = item.Substring(0, item.Length - 4)
            If frmoutward.CustomeChecklistbox5.CheckedItemsCount = 0 Then
                For i = 0 To frmoutward.CustomeChecklistbox5.ItemsCount - 1
                    mst = mst & "mst='" & frmoutward.CustomeChecklistbox5.getItems(i).ToString & "' or "
                Next
            Else
                For i = 0 To frmoutward.CustomeChecklistbox5.CheckedItemsCount - 1
                    mst = mst & "mst='" & frmoutward.CustomeChecklistbox5.getCheckedItems(i).ToString & "' or "
                Next
            End If
            ...
            da = New SqlDataAdapter("select * from tblAccount where (" & group & ")", cn)
            da.Fill(ds, "tblAccount")
            da = New SqlDataAdapter("select * from sale where (" & book & ") and (" & mst & ") and (" & Name & ") and accode in (select accode from tblAccount where (" & group & "))", cn)
            da.Fill(ds, "sale")
            da = New SqlDataAdapter("Select * from sale1 where (" & process & ") and accode in (select accode from tblAccount where (" & group & "))", cn)
            da.Fill(ds, "sale1")
