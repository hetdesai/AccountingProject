...
en:
    ...
    Private Sub saveproc()
        Try
            ...
            Dim a() As String = {txtVrNofirst.Text & txtVrNosec.Text, dat1.Month & "-" & dat1.Day & "-" & dat1.Year, txtBkcode.Text, txtBkname.Text, txtBkcode.Text, txtBkname.Text, txtAmount.Text, txtRemark.Text, txtChqNo.Text, txtRefBank.Text, "Bank", txtAcname.Text, txtAccode.Text, txtSlipNo.Text, " ", txtReciptVrNo.Text, "f", dat1.Month & "-" & dat1.Day & "-" & dat1.Year, ComboBox1.Text.ToUpper}
