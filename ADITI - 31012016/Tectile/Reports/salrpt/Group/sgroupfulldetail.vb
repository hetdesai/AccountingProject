...
Public Class sgroupfulldetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.sgroupfulldetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsgroupfulldetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As sgroupfulldetail = New sgroupfulldetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
