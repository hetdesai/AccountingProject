...
Public Class grouppartymonth
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.grouppartymonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgrouppartymonth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As grouppartymonth = New grouppartymonth()
        rpt.Site = Me.Site
        Return rpt
    End Function
