...
Public Class rptTreadingMain2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptTreadingMain2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTreadingMain2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTreadingMain2 = New rptTreadingMain2()
        rpt.Site = Me.Site
        Return rpt
    End Function
