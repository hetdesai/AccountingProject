...
Public Class rptprocessmonthcross2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptprocessmonthcross2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptprocessmonthcross2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptprocessmonthcross2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptprocessmonthcross2 = New rptprocessmonthcross2()
        rpt.Site = Me.Site
        Return rpt
    End Function
