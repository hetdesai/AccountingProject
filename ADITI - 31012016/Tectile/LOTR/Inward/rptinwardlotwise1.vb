...
'        Get
'            Return "Tectile.rptinwardlotwise.rpt"
'        End Get
'        Set(value As String)
'            'Do nothing
'        End Set
...
'Public Class Cachedrptinwardlotwise
'    Inherits Component
...
'        Dim rpt As rptinwardlotwise = New rptinwardlotwise()
'        rpt.Site = Me.Site
'        Return rpt
'    End Function
