...
Public Class rptratemaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptratemaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptratemaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptratemaster = New rptratemaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
