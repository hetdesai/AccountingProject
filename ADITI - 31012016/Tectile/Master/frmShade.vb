...
Public Class frmShade
    ...
    Private Sub frmGroupMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If frmACMaster.groupcheck = 1 Then
                ...
                myserialno("tblShade", TextBox1, "SHCode")
                GroupBox1.Focus()
                TextBox2.Focus()
            Else
                connect()
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            ...
            ElseIf check = 2 Then
                Dim a() As String = {TextBox1.Text, TextBox2.Text}
                If (duplicate("tblShade", "SHADE", TextBox2)) = True Then
                ...
                myupdate("tblShade", a, "SHCode", TextBox1.Text)
                Dim rowi As Integer
                Dim coli As Integer
                Dim i As DataGridViewSelectedCellCollection
                i = dg1.SelectedCells
...
en:     Catch ex As Exception
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            ...
            CMD = New SqlCommand("DELETE FROM tblShade WHERE SHADE='" & TextBox2.Text & "'", cn)
            CMD.ExecuteNonQuery()
            myfilldatagrid(dg1, "tblShade")
            close1()
        Catch ex As Exception
