...
Public Class rptTreadingIn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptTreadingIn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTreadingIn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTreadingIn = New rptTreadingIn
        rpt.Site = Me.Site
        Return rpt
    End Function
