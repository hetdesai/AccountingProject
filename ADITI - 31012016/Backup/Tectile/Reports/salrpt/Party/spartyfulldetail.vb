...
Public Class spartyfulldetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.spartyfulldetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedspartyfulldetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As spartyfulldetail = New spartyfulldetail
        rpt.Site = Me.Site
        Return rpt
    End Function
