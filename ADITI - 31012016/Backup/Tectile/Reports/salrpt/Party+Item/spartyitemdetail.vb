...
Public Class spartyitemdetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.spartyitemdetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedspartyitemdetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As spartyitemdetail = New spartyitemdetail
        rpt.Site = Me.Site
        Return rpt
    End Function
