...
Public Class sgrouppartysum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.sgrouppartysum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsgrouppartysum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As sgrouppartysum = New sgrouppartysum
        rpt.Site = Me.Site
        Return rpt
    End Function
