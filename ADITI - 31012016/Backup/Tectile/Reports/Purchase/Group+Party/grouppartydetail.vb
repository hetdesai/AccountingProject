...
Public Class grouppartydetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.grouppartydetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgrouppartydetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As grouppartydetail = New grouppartydetail
        rpt.Site = Me.Site
        Return rpt
    End Function
