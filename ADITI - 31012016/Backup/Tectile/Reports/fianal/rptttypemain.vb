...
Public Class rptttypemain
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptttypemain.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_COMPANYNAME2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrptttypemain
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptttypemain = New rptttypemain
        rpt.Site = Me.Site
        Return rpt
    End Function
