...
Public Class FRMPRINTGROUP
    Dim DS As New DataSet
    Dim DA As New SqlDataAdapter
    Private Sub FRMPRINTGROUP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        DA = New SqlDataAdapter("SELECT * FROM TBLPGROUP", cn)
        DA.Fill(DS, "TBLPGROUP")
