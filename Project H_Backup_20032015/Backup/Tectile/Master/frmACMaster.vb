...
Public Class frmACMaster
    ...
    Private Sub frmACMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If Form3.newac = 1 Or Form3.newac = 2 Or frmOpeningMaster.acbalance = 1 Or frmSale.newac = 1 Or frmSale.newac = 2 Or frmBank.bankac = 1 Or frmBankRecipt.bankrac = 1 Or frmJour.jourac = 1 Or frmoub.acbalance = 1 Or frmlotr.lotracm = 1 Or FRMChalan.newac = 2 Or FRMChalan.newac = 3 Then
                dg1.Enabled = False
