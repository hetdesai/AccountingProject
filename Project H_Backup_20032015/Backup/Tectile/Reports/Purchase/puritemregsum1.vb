...
Public Class puritemregsum1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.puritemregsum1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpuritemregsum1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As puritemregsum1 = New puritemregsum1
        rpt.Site = Me.Site
        Return rpt
    End Function
