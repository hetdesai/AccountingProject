...
Public Class partyitemmonth
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.partyitemmonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpartyitemmonth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As partyitemmonth = New partyitemmonth
        rpt.Site = Me.Site
        Return rpt
    End Function
