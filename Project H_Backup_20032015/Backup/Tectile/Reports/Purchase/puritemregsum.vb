...
Public Class puritemregsum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.puritemregsum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpuritemregsum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As puritemregsum = New puritemregsum
        rpt.Site = Me.Site
        Return rpt
    End Function
