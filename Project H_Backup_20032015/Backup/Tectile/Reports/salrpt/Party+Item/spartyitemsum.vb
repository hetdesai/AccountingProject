...
Public Class spartyitemsum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.spartyitemsum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedspartyitemsum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As spartyitemsum = New spartyitemsum
        rpt.Site = Me.Site
        Return rpt
    End Function
