...
Public Class sgrouppartydetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.sgrouppartydetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsgrouppartydetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As sgrouppartydetail = New sgrouppartydetail
        rpt.Site = Me.Site
        Return rpt
    End Function
