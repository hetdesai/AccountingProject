...
Public Class rptTreadingex
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptTreadingex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTreadingex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTreadingex = New rptTreadingex
        rpt.Site = Me.Site
        Return rpt
    End Function
