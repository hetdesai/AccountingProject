...
Public Class rptoutpartydetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptoutpartydetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptoutpartydetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptoutpartydetail = New rptoutpartydetail
        rpt.Site = Me.Site
        Return rpt
    End Function
