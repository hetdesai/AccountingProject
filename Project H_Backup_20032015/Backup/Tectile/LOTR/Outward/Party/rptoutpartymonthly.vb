...
Public Class rptoutpartymonthly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptoutpartymonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptoutpartymonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptoutpartymonthly = New rptoutpartymonthly
        rpt.Site = Me.Site
        Return rpt
    End Function
