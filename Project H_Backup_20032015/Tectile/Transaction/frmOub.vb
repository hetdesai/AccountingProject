    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butSave.Click
        Try
            ...
            If check = 1 Then
                ...
                Dim a() As String = {txtVrnofirst.Text & txtVrnoSec.Text, dat.Month & "-" & dat.Day & "-" & dat.Year, comBook.Text, txtAcname.Text, txtAccode.Text, txtAmount.Text, txtType.Text.ToUpper, txtDescr.Text, txtBkname.Text, txtBkcode.Text, comoubyear.Text & txtOubnosec.Text, Val(txtAmount.Text), "f"}
                myinsert(a, "tbloub")
                ...
                Else
                    ...
                    DRCHECK = 0
                End If
                Dim B() As String = {txtVrnofirst.Text & txtVrnoSec.Text, "PRE" & comBook.Text, dat.Month & "-" & dat.Day & "-" & dat.Year, txtAccode.Text, txtAcname.Text, DRCHECK, CRCHECK, (CRCHECK - DRCHECK), "PREV", comoubyear.Text & txtOubnosec.Text, txtBkname.Text, txtBkcode.Text}
                '    myinsert(B, "TBLlEDG")
                Dim C() As String = {txtVrnofirst.Text & txtVrnoSec.Text, "PRE" & comBook.Text, dat.Month & "-" & dat.Day & "-" & dat.Year, txtBkcode.Text, txtBkname.Text, CRCHECK, DRCHECK, (DRCHECK - CRCHECK), "PREV", comoubyear.Text & txtOubnosec.Text, txtAcname.Text, txtAccode.Text}
                '   myinsert(C, "TBLlEDG")
                '  Dim b() As String = {acycode & "/" & TextBox1.Text, "OPBAL", dat.Month & "-" & dat.Day & "-" & dat.Year, TextBox3.Text, TextBox2.Text, dr1, cr, Val(cr - dr1), TextBox6.Text, "Ref", "OPBAL", 0}
                ' myinsert(b, "tblLedg")
                myfilldatagrid(DG1, "tblOub")
                DG1.Item(0, DG1.RowCount - 1).Selected = True
                DG1.Refresh()
            ...
            ElseIf check = 2 Then
                ...
                connect()
                cmd = New SqlCommand("DELETE FROM TBLLEDG WHERE VRNO='" & txtVrnofirst.Text & txtVrnoSec.Text & "' AND BOOK='PRE" & comcopyBook.Text & "'", cn)
                cmd.ExecuteNonQuery()
                close1()
                Dim B() As String = {txtVrnofirst.Text & txtVrnoSec.Text, "PRE" & comBook.Text, dat.Month & "-" & dat.Day & "-" & dat.Year, txtAccode.Text, txtAcname.Text, DRCHECK, CRCHECK, (CRCHECK - DRCHECK), "PREV", comoubyear.Text & txtOubnosec.Text, txtBkname.Text, txtBkcode.Text}
                myinsert(B, "TBLlEDG")
...
en:
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butEdit.Click
        ...
        txtDescr.Text = DG1.Item(7, i.Item(0).RowIndex).Value
        GroupBox1.Enabled = True
        dgacm.Visible = False
        maskDate.Focus()
    End Sub
    ...
    Private Sub DG1_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DG1.RowEnter
        Try
            ...
            txtDescr.Text = DG1.Item(7, e.RowIndex).Value
    ...
    Private Sub TextBox4_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtAmount.KeyDown
        ...
        End If
    End Sub
    Private Sub TextBox6_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDescr.KeyDown
        If e.KeyCode = Keys.Enter Then
            butSave.Focus()
        ElseIf e.KeyCode = Keys.Up Then
            txtType.Focus()
