...
Public Class FRMPRINTITEMForm2
    Dim DS As New DataSet2
    Dim DA As New SqlDataAdapter
    Private Sub FRMPRINTITEMForm2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            DA = New SqlDataAdapter("SELECT * FROM TBLITEM", cn)
            DA.Fill(DS, "TBLITEM")
