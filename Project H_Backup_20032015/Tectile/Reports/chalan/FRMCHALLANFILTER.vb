    ...
    Private Sub CheckedListBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckedListBox1.SelectedIndexChanged
        Try
            ...
            For I = 0 To CheckedListBox2.Items.Count - 1
                CMD = New SqlCommand("Select chno from ch1 where acname='" & CheckedListBox2.Items(I).ToString & "'", cn)
                DR = CMD.ExecuteReader
                While DR.Read
...
EN:
        ...
        Try
            ...
            Else
                For i = 0 To CheckedListBox2.CheckedItems.Count - 1
                    cmd = New SqlCommand("select chno from ch1 where acname='" & CheckedListBox2.CheckedItems(i).ToString & "'", cn)
                    dr = cmd.ExecuteReader
                    While dr.Read
                        CheckedListBox3.Items.Add(dr.Item(0))
                    End While
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            ...
            Dim cmd As New SqlCommand
            Dim dr As SqlDataReader
            cmd = New SqlCommand("select chno from ch1 where date >= '" & dat1.Month & "-" & dat1.Day & "-" & dat1.Year & "' and date <= '" & dat2.Month & "-" & dat2.Day & "-" & dat2.Year & "'", cn)
            dr = cmd.ExecuteReader
            While dr.Read
                CheckedListBox3.Items.Add(dr.Item(0))
            End While
    ...
    Private Sub CheckedListBox1_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckedListBox1.LostFocus, CheckedListBox2.LostFocus, CheckedListBox3.LostFocus
        ...
        sender.BackColor = Color.White
    End Sub
    Private Sub FRMCHALLANFILTER_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            End While
            dr.Close()
            cmd = New SqlCommand("Select chno from ch1", cn)
            dr = cmd.ExecuteReader
            While dr.Read
                CheckedListBox3.Items.Add(dr.Item(0))
            End While
