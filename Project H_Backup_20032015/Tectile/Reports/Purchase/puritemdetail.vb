...
Public Class puritemdetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.puritemdetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpuritemdetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As puritemdetail = New puritemdetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
