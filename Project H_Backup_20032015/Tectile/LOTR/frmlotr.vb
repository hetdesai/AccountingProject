    ...
    Private Sub DG1_CellValidated(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DG1.CellValidated
        Try
            If e.ColumnIndex = 1 Then
                ...
                txtTotalwidth.Text = ""
                txttotalpcs.Text = ""
                txttotalpcs.Text = DG1.Rows.Count - 1
...
last:
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            ...
            If MsgBox("You want to delete entry for VrNo=" & txtVrNo1.Text & txtVrNo2.Text, MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                connect()
                Dim cmd As New SqlCommand
    ...
    Private Sub MaskedTextBox1_Leave1(ByVal sender As Object, ByVal e As System.EventArgs) Handles masklotno.Leave
        ...
        Else
            ...
            Dim cmd As New SqlCommand
            Dim dr As SqlDataReader
            cmd = New SqlCommand("select * from tblLotr where lotno='" & txtLotno1.Text & masklotno.Text & "'", cn)
            dr = cmd.ExecuteReader
            If dr.HasRows Then
