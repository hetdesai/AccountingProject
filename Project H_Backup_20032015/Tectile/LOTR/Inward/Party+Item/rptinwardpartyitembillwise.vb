...
Public Class rptinwardpartyitembillwise
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptinwardpartyitembillwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptinwardpartyitembillwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptinwardpartyitembillwise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptinwardpartyitembillwise = New rptinwardpartyitembillwise()
        rpt.Site = Me.Site
        Return rpt
    End Function
