...
Public Class rptinwardlotdaily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptinwardlotdaily.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptinwardlotdaily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptinwardlotdaily = New rptinwardlotdaily()
        rpt.Site = Me.Site
        Return rpt
    End Function
