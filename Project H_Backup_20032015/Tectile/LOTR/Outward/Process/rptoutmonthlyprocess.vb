...
Public Class rptoutmonthlyprocess
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptoutmonthlyprocess.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptoutmonthlyprocess.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptoutmonthlyprocess
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptoutmonthlyprocess = New rptoutmonthlyprocess()
        rpt.Site = Me.Site
        Return rpt
    End Function
