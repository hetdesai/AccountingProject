...
Public Class rptpurcpartywise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tectile.rptpurcpartywise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptpurcpartywise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptpurcpartywise = New rptpurcpartywise
        rpt.Site = Me.Site
        Return rpt
    End Function
